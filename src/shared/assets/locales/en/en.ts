export const en = {
  ...
  wiki: {
    ...
    celestiaBattleHeader: 'Celestial Battle',
  },
  mainInfo: {
  ...
  offlineHunting: {
    ...
    serverRestartRestoreCharacters:
      'After restarting the server, it restores characters in the Open World and ' +
      'does not ' +
      'restore them in Special Zones.',
    offlineHuntingDurationLimit:
      'Offline Hunting is valid for a maximum of 48 hours, after which the character ' +
      'will be ' +
  ...
  celestiaBattle: {
    header: 'Celestial Battle',
    intro:
      'Every Friday, when the Celestial Tower becomes available at 21:00, the event "Celestial Battle" begins.',
    stage1: {
      header: 'First Stage',
      start: 'Begins at 21:00 and lasts for 40 minutes.',
      portals:
        'On the 1st floor of the Tower of Audacity portals to other worlds open, remaining accessible for the duration of the event. ' +
        'On the top floor of the Tower of Audacity the boss Thoros appears.',
      scaling: 'Thoros grows stronger as his health decreases.',
      defendersRule1:
        'The player who deals the final blow to Thoros becomes a Defender of the Celestial Tower. ' +
        'The maximum number of Defenders is 5 — one for each kill of Thoros.',
      transition:
        'At 21:40 Thoros disappears and the next stage of the event begins.',
    },
    stage2: {
      header: 'Second Stage — Camp Selection.',
      camp: 'Camp Selection.',
      start: 'Begins at 21:40 and lasts for 10 minutes.',
      knights1:
        'Players who did not become a Defender become Knights. Their nickname changes to "Knight".',
      knights2: 'Until a camp is chosen, Knights cannot chat or form parties.',
    },
    stage3: {
      header: 'Third Stage — Celestial Battle',
      start: 'Begins at 22:00 and lasts for 60 minutes.',
      rewardPool: 'One of five possible rewards is randomly selected.',
      ferion: 'The Celestial Emperor Ferion appears.',
      summoning:
        'During the battle with the Celestial Emperor an ability periodically activates that allows Ferion to summon minions.',
      battlefield:
        'The battlefield changes its appearance. A player without the Celestial Cloak who deals damage to Ferion during this phase will be forcibly teleported to a special zone as punishment.',
      specialZoneExit:
        'The special zone can be left either via the teleportation sphere once the negative effect expires, or by killing the monster in the centre of the room.',
      campPoints:
        'Camp points are awarded for killing Ferion’s minions and monsters within the special zone.',
      pointsFromMobs:
        'Killing monsters grants the camp between 126 and 141 points.',
      pointsFromFerionLastHit:
        'For delivering the final blow to the Celestial Emperor Ferion, the camp receives 10,000 points.',
    },
    stage4: {
      header: 'Fourth Stage — Reward',
      start: 'From 23:00 to 23:59 (59 minutes).',
      leadersReward:
        'At the entrance to the Celestial Tower, Magmeld appears; Defenders of the Celestial Tower (camp leaders) can receive the Celestial Cloak as a reward.',
      condition: 'The reward can only be obtained if Ferion has been defeated.',
      knightsReward:
        'Knights receive their reward via a special interface with a certain chance.',
      chanceCalcIntro: 'The chance is calculated as follows:',
      baseChances: {
        header:
          'A base chance is determined depending on the place the camp achieved.',
        place1: 'Base chance for the 1st place camp — 100',
        place2: 'Base chance for the 2nd place camp — 50.0',
        place3: 'Base chance for the 3rd place camp — 25.0',
        place4: 'Base chance for the 4th place camp — 12.5',
        place5: 'Base chance for the 5th place camp — 6.25',
      },
      numberKnights:
        'The base chance is divided by the number of Knights in the camp.',
    },
  },
  metaTagsInfo: {
    mainPage: {
    ...
    description:
      'Rebirth — a Essence server for those who value fair play. ' +
  ...
  privacyPolicy: {
    ...
    generalProvisions: {
      ...
      policyDefinition:
        'This Policy is an official document of the l2rebirth.net Internet resource website ' +
        'https://l2rebirth.net, and determines the procedure for processing and protecting information about Users.',
      regulationScope:
        'Relations related to the collection, storage, distribution and protection of information about ' +
      ...
      userAgreementConsent:
        'By registering on the Site and using it, the User agrees with the terms and conditions ' +
        'set forth in this Policy. If the User disagrees with this Policy, use of the Site and its service must be ' +
        'immediately terminated.',
      voluntaryDonations:
        'Все платежи на сайте l2rebirth.net являются добровольными пожертвованиями.',
      dataAccuracyCheck:
        'The Site Administration does not verify the accuracy of the information received (collected) ' +
    ...
    dataProcessing: {
      ...
      personalDataPolicy:
        'The Site Administration does not require the provision of personal data, but in cases of ' +
      ...
      dataUsePurposesIntro: {
        header:
          'The Site Administration may use the User’s personal information for the following purposes:',
        ...
        purposeImprovement:
          'Improving the quality of service on the Site, the convenience of the Site, developing new ' +
          'functions of the Site;',
        purposeAnalytics:
          'Conducting statistical and other studies based on anonymized data.',
      },
      dataStorageRules:
        'The Site Administration stores personal information of Users in accordance with internal ' +
        'regulations.',
      confidentialityClause:
        "With regard to the User's personal information, its confidentiality is maintained, " +
      ...
      dataTransferCasesIntro: {
        header:
          'The Site Administration has the right to transfer the User’s personal information to third parties in ' +
          'the following cases:',
        dataTransferConsent:
        ...
        dataTransferLaw:
          'The transfer is provided for by or other applicable legislation within the framework of ' +
          'the procedure established by law;',
        dataTransferBusiness:
          'Such a transfer occurs as part of the sale or other transfer of a business (in whole ' +
        ...
        dataTransferRightsProtection:
          'In order to ensure the possibility of protecting the rights and legitimate ' +
          'interests of the Site Administration or third parties in cases where the User violates the User Agreement.',
      },
      dataProtectionLaw:
        'When processing personal data of Users, the Site Administration is guided by the Law of ' +
        '“On the Protection of Personal Data”.',
    },
    policyChanges: {
      header: 'The procedure for enacting and changing the Policy.',
      policyEffect:
        'The Policy comes into force from the moment of publication on the Site and is valid indefinitely ' +
        'until it is replaced by a new Policy.',
      currentEdition:
        'The current version of the Policy, which is a public document.',
      policyModification:
        'The Site Administration has the right to make changes to the Policy. When changes are made, ' +
        'the Site Administration notifies users by posting the new edition on the Site at a permanent address.',
      userContinuation:
        'Continued use of the Site by the User after posting the Policy in a new edition or posting the ' +
  ...
  userAgreement: {
    ...
    description:
      'The following agreement establishes the relationship between the user and the owner',
    terms: {
      header: 'Terms used',
      providerDefinition:
        'The provider is the copyright holder of the l2rebirth.net Portal and is a party to the ' +
      ...
      userDefinition:
        'The User is an individual who visits the Portal or participates in the projects of the Portal ' +
        'l2rebirth.net. The User, like the Provider, is a party to the Agreement.',
      portalDefinition:
        "The portal is a software and hardware complex hosted on the Provider's resources. Users' " +
        'access to the Portal is provided only by the Provider. All rights to use this Portal belong exclusively ' +
        'to the Provider.',
      websiteDefinition:
        'Website – an Internet site — l2rebirth.net (hereinafter referred to as the website).',
      paidServicesDefinition:
        'Additional paid services – providing the User with additional special features of the ' +
    ...
    agreementSubject: {
      ...
      accessProvision:
        'Provision by the Provider of access to the Portal, as well as Services and Paid Services to an ' +
        'unlimited number of persons, under the terms of this Agreement.',
      priceListNotice:
        'You can get acquainted with the list of goods, services and their prices by clicking ' +
        'on this link.',
    },
    agreementEffective: {
      header: 'The procedure for entry into force',
      acceptanceEffect:
        'From the moment of acceptance of this Agreement, the User has the rights and performs ' +
        'the duties stipulated in the text of this Agreement.',
      acceptanceMethod:
        'The User accepts and agrees to the terms of this Agreement by registering on the website. ' +
        'The fact of acceptance means that the User fully and unconditionally accepts all the terms and appendices ' +
        'of this Agreement.',
      disagreementObligation:
        'If for any reason the User does not agree with the terms of this Agreement, he is ' +
        'obliged to stop further use of l2rebirth.net.',
      usageCondition:
        'You may use the l2rebirth.net website only after the User accepts this Agreement.',
    },
    rightsAndObligations: {
      ...
      userRights: {
        ...
        userRightsList: {
          ...
          rightUseServices:
            'Use all services and resources (including Additional Paid Services) provided by the ' +
            'Provider.',
          rightTechnicalSupport:
            'If necessary, use the technical support of the sites, contact the Provider if you ' +
      ...
      userRestrictions: {
        ...
        userRestrictionsList: {
          header:
            "Using the Operator's Portal, the User does not have the right to:",
          restrictionBugs:
            'Use any errors (bugs) of the website, unauthorized access to the shared database, ' +
            'logging into the computer system, changing the program code.',
          restrictionMalware:
            'The User is prohibited from using malicious programs capable of harming the Portal, ' +
            'as well as special software that gives him superiority over other users.',
          restrictionSanctions:
            'If such and similar violations are detected, the Provider has the right to impose ' +
    ...
    providerRights: {
      ...
      rightModifyServices:
        'At any time, at its discretion, the Provider may unilaterally, without prior notice, ' +
        'expand, terminate, or restrict the provision of Services, as well as Additional Paid Services.',
      rightNotifyUser:
        'Inform, warn, comment, notify the User in case of non-compliance or violation of the terms ' +
    ...
    providerObligations: {
      ...
      obligationProvideServices:
        "To ensure the possibility of using the Provider's Services within the framework " +
        'of this Portal (including obtaining Additional Paid Services).',
      obligationSupportUsers:
        "Answer the User's questions, and in case of disputes, take all measures to resolve them.",
    },
    providerLiabilityLimitation: {
      header: 'Limitation of liability of the Provider',
      providerLiabilityIntro:
        'In accordance with this section, the Provider is not responsible for: ',
      liabilityPersonalData:
        "Any damage caused or that can only be caused to the User's personal data and computer " +
        'after using the Portal and the Site.',
      liabilityUserLosses:
        'Losses (direct/indirect) caused to the User as a result of the use or unavailability of ' +
      ...
      liabilityUserActions:
        'Statements, disseminated information, statements of the User and other illegal actions ' +
        'carried out by him on the Portal and beyond.',
      liabilityVirtualLoss:
        'Loss of the acquired virtual values by the User as a result of the provision of Services ' +
    ...
    providerNoGuarantees: {
      ...
      guaranteeUninterruptedWork:
        'Continuous, reliable, error-free operation of the Portal, access to its resources, ' +
        'Services, including Additional Paid Services.',
      guaranteeUserExpectations:
        "The fact that the Portal will fully meet the User's expectations and ideas.",
      guaranteeServiceQuality:
        'Compliance of the quality of the Services provided (Additional Paid Services) with ' +
        "the User's expectations.",
      guaranteeNoDisclosure:
        "The Provider is not obligated, upon the User's request, to provide documents and other " +
    ...
    paidServices: {
      ...
      paidServiceProvision:
        'At the request of the User, the Provider provides Additional Paid Services. They allow ' +
        'him to use the expanded features of the Portal. ',
      paidServiceOptional:
        'Additional Paid Services are not mandatory for using the Portal and participating in ' +
        'Portal projects.',
      paidServiceCompletion:
        "From the moment the funds are paid to the Portal Provider from the User's account, the " +
        'Additional Paid Service is considered to have been provided in full and of proper quality.',
      paidServiceNoRefund:
        'After the purchase of Additional Paid Services, the payment will not be refunded.',
      paidServicePersonalData:
        'The User agrees that the Provider has the right to store personal information ' +
        'obtained when purchasing Additional Paid Services.',
      paidServiceListPublication:
        'The list of Additional Paid Services and their cost are published only by the ' +
      ...
      paidServiceAcquisitionMethods:
        'The ways and means of purchasing Additional Paid Services are explained by the ' +
        'Provider on the Website.',
      paidServicePaymentSystems:
        'The Provider does not provide explanations on the issues of working with various ' +
      ...
      paidServiceTechnicalIssues:
        'In the event of a technical malfunction of the sites or intentional actions of the ' +
      ...
      paidServiceNoCompensation:
        'The Provider does not reimburse the User for unused (partially used) Additional ' +
        'Paid Services.',
      paidServiceUserExpenses:
        'The User shall independently bear all financial expenses related to the purchase ' +
        '(transfer of money) at his own expense Additional Paid Services. This section includes: commissions, fees, ' +
        'and other expenses.',
      paidServiceUserGuarantee:
        'The User guarantees to the Provider that he has all the legal powers and rights to ' +
        'conclude this Agreement regarding Additional Paid Services.',
      paidServiceUnderageConsent:
        'In case of purchase of Additional Paid Services by a User under the age of 18, he ' +
      ...
      paidServiceResponsibility:
        'The responsibility for the purchase of Additional Paid Services lies entirely with ' +
        'the User and his legal representatives.',
      paidServiceDisputeProhibition:
        'Disputes about liability for the purchase of Additional Paid Services with the ' +
        'Portal Provider are unacceptable.',
      paidServicePaymentRequirement:
        'The User can receive additional Paid services only after full payment of ' +
        'their cost.',
    },
    refundPolicy: {
      header: 'Refund',
      refundCompletion:
        "From the moment of payment of funds to the Portal Provider from the User's account, the " +
        'additional Paid service is considered to have been provided in full and of proper quality.',
      refundLawClarification:
        'All products and services on the portal are digital goods. In accordance with the law ' +
      ...
      refundFinal:
        'All sales of Digital Gaming Products are final, but we understand that there may be legitimate ' +
      ...
      refundDisposableItems:
        'For single-use items (such as supplies or in-game currency) Your request will only ' +
    ...
    disclaimer: {
      ...
      disclaimerText:
        'All services on the portals are provided to users according to the stated concept "as is". ' +
      ...
      disclaimerLiability:
        'he portal is not responsible for civil offenses, negligence, unlimited liability, etc. for ' +
