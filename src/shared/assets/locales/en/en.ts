const en = {
  ...
  swiperText: {
    ...
    roseVainUpdateText:
      'New class, new locations and special zones. Updated all available locations, special hunting zones, quests and bosses. ' +
      'You will receive a lot of pleasant rewards and comfortable character development.',
    coinsLHeader: 'L Coins',
    coinsLText:
      'Coin mining is only a game way, the purchase will not be available for donations. Dropout per day is unlimited, the dropout interval is 2 seconds when defeating monsters, with a 70% chance. ' +
      "The Quantity depends on the character's level.",
    olympiadHeader: 'Olympiad',
    olympiadText:
      'The battle of 1vs1. The battle takes place in the form of 3 battles of 1:30 min.The Heroic Bravery and Heroic Berserk skills are awarded to the winners in their class. ' +
    ...
    itemDropSystemText:
      'All monsters of level 90 and above drop equipment items, equipment modification scrolls, and more. Significantly simplified crafting and the chance to modify the weapons of the Ice Monarch needed to create Dragon weapons.',
  },
  pagination: {
  ...
  starterKit: {
    header: 'Starter Kit',
    packageFree:
      'Welcome free starter kit for 0 L Coins is available in the Events and Promotions section of the L Store, ' +
  ...
  rewardsForTasks: {
    ...
    bonusForReading:
      'And also, if you are reading this, then an additional promo code reward has been prepared for you FFBB-KLMU-RECN-ASDF.',
  },
  newUniqueTasks: {
    header: 'New Unique Tasks',
    earringOfZaken:
      'Pirate King – When participating in a battle with Zaken, deal damage and stay within a 2000 radius when killing the Boss.',
    earringOfOrfen:
      'Forty Hands – When participating in the battle with Orfen, deal damage and be within a radius of 2000 when killing the Boss.',
    accessoryRingOfQueenAnt:
      'Centipede – When participating in the battle with the Ant Queen, deal damage and be within a radius of 2000 when killing the Boss.',
    baiumTalismanNew:
      'Cursed Emperor – When participating in the battle with Baium, deal damage and be within a radius of 2000 when killing the Boss.',
    blessMaskOfPhantom:
  ...
  rewardsSeasonPass: {
    ...
    huntingPointsIncrease:
      'Each time a monster is destroyed, the hunting score increases by 1, and when monsters are destroyed in session zones, the hunting score increases by 2.',
  ...
  normalCreation: {
    ...
    craftingRewards:
      "Rewards have been completely redesigned, and it's now possible to get Giran seals, power banks, and more for crafting attempts.",
    potionBlue:
      'Reduces Physical Defense. and reflects the damage to the enemy.',
    dragonPotionLvl1: {
  ...
  guaranteedEnhancement: {
    ...
    synthesisAndModification:
      'When Synthesizing, Modifying, and creating an item through a Special Creation system, guaranteed skill points are accumulated for some items.',
    pointsResetOnSuccess:
      'When successfully created or improved, the points are reset.',
    notForAllItems:
      'It does NOT work FOR ALL ITEMS, unlike for those who read this text, who can get additional benefits when starting with a promo code GJPP-DFVB-DERT-AQNB',
  },
  quests: {
    header: 'Quests',
  ...
  gameAssistant: {
    ...
    ravenAndVulkanChance:
      "With a small chance, the Guardian of Ravens and Vulcan can be obtained from the chest with the Guardian's Sealed Necklace.",
    glassiaChance:
      "With a very small chance, a new Guardian Glassia can be obtained from the chest with the Guardian's Sealed Necklace.",
    gemsAndChestsExchange:
      'Jewels and Boxes of level 1 and 2 are exchanged for a ticket for a selected gemstone, which, in turn, can be exchanged for a higher level of stones upon accumulation.',
    relicFragmentExchange:
      'Using materials: an ingot of Iron, wood, varnish, a metallograph, leather or fabric, you can exchange for a fragment of the relic of Aden. which can be obtained with the help of a Special Creation with a 30% chance.',
    relicFragmentToDiary:
      "Using a Special Creation with a 30% chance, a fragment of the Aden Relic can be turned into the Aden's Exploration Report, necessary for the improvement of the Aden Laboratory.",
    soulBeadExchange:
      'By disassembling some improved equipment, you can get a Large Strengthening Stone, which is necessary to safely upgrade equipment from +5 to +7.',
    epicJewelryScroll:
      'When parsing epic jewelry, you can get a chance to Modify Rare Accessories and an Improved Scroll to Modify Rare Accessories.',
    equipmentSale:
  ...
  locationsAndHuntingZones: {
    ...
    kelbimaFortressAndOthers:
      'The Fortress of Kelbim, the Pagan Temple and the Heavenly Tower will now be accessible simultaneously without changing cycles.',
    hellIslandSchedule: 'Hell Island on Saturdays from 10:00 to 00:00 GMT+3.',
    incredibleTimeZone:
      'The amount of experience gained in the Incredible Time Zone has been significantly increased (recommended for all characters after receiving 3 professions). ' +
  ...
  treasureChest: {
    ...
    chestContent: {
      header:
        'The key to an Incredible Treasure Chest. When opened, a chest with a 40% chance will kill the player, with a 60% chance it will give rewards, here are some of them.',
  ...
  newsList: {
    ...
    newUniqueTasks: {
      header: 'New Unique Tasks',
      description:
        'In battles against epic bosses, rewards are given to all participants who deal damage and are within a 2000 radius when killing a Boss.',
    },
  },
  privacyPolicy: {
