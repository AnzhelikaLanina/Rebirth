...
export const olympiadData = [
  ...
  {
    key: 'stableWeaponScroll',
    src: giantScrlOfEnchWpA,
    alt: 'giant scrl of ench wp a',
  },
  {
    key: 'stableArmorScroll',
    src: giantScrlOfEnchAmA,
    alt: 'giant scrl of ench am a',
  },
  {
    key: 'stableRareAccessoriesScroll',
    src: etcStableScrlOfEnchFallenAngel,
    alt: 'etc stable scrl of ench fallen angel',
  },
  {
    key: 'xpSpRune',
    src: skill19226,
