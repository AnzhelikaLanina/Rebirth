...
export const rewardsCalendarData = [
  ...
  {
    src: agathionValakas,
    alt: 'agathion valakas',
    key: 'agathionValakas',
  },
  {
    src: bmPendantOfGrankain,
    alt: 'bm pendant of grankain',
    key: 'pendantOfGrankain',
  },
  {
    src: noblessCloak,
    alt: 'nobless cloak',
  ...
  {
    src: frozenWeaponTicket,
    alt: 'frozen weapon ticket',
    key: 'monarchWeaponCoupon',
  },
];